...
ARG NEXT_PUBLIC_DESKTOP_DOWNLOAD_BASE_URL
ARG NEXT_PUBLIC_DESKTOP_MACOS_DOWNLOAD_URL
ARG NEXT_PUBLIC_DESKTOP_WINDOWS_DOWNLOAD_URL
...
ENV NEXT_PUBLIC_SITE_URL="${NEXT_PUBLIC_SITE_URL}" \
    ...
    NEXT_PUBLIC_DESKTOP_DOWNLOAD_BASE_URL="${NEXT_PUBLIC_DESKTOP_DOWNLOAD_BASE_URL}" \
    NEXT_PUBLIC_DESKTOP_MACOS_DOWNLOAD_URL="${NEXT_PUBLIC_DESKTOP_MACOS_DOWNLOAD_URL}" \
    NEXT_PUBLIC_DESKTOP_WINDOWS_DOWNLOAD_URL="${NEXT_PUBLIC_DESKTOP_WINDOWS_DOWNLOAD_URL}" \
