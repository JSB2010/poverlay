...
def timeseries_to_framemeta(
    gpx_timeseries: Timeseries,
    units,
    start_date: datetime.datetime = None,
    duration: Timeunit = None,
    ...
    if packets_per_second is None:
        packets_per_second = max(1, int(round(1.0 / step_seconds)))

    fake_frame_meta = FrameMeta(packets_per_second=packets_per_second)
    ...
    stepper = gpx_timeseries.stepper(step=timeunits(seconds=step_seconds))
